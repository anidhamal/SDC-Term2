...
The equations of the model used for this project
```
      ...
      epsi[t+1] = psi[t] - psi[t] + v[t] * delta[t] / Lf * dt
```
...
I used 3rd degree polynomial for the trajectory of the car as most of the roads are fitted in third degree polynomial.

```
            double diff_x = ptsx[i] - px;
            double diff_y = ptsy[i] - py;
            waypoints_x_eig[i] = (diff_x * cos(0-psi) - diff_y * sin(0-psi));
            waypoints_y_eig[i] = (diff_x * sin(0-psi) + diff_y * cos(0-psi));
```

## Model Predictive Control with Latency

I have accomodated latency of 100ms in the model by predicting values based on the delay. Waypoints that are being passed to MPC solver, have already considered the latency.
...
## Video of the drive
[MPC Video](https://youtu.be/7UwAnAVmJTM)
